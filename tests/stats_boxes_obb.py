...
def count_rotated_boxes(label_folders):
    ...
    for folder in label_folders:
        ...
        rotated_boxes_percentage[folder] = (rotated_boxes_count / total_boxes_count) * 100 if total_boxes_count > 0 else 0
    return rotated_boxes_percentage
...
rotated_boxes_percentage = count_rotated_boxes([label_folder1, label_folder2, label_folder3])
