...
# Funktionen zum Einlesen der Klassenverteilung
distribution_file = 'class_distribution_rp_v2.txt'
class_distribution, num_lines = read_class_distribution(distribution_file)
...
for idx, combo in tqdm(enumerate(parameter_combinations, start=6), desc="Parameter combinations"):
    ...
    for i, distribution in enumerate(tqdm(class_distribution, desc=f"Generating images for {name}")):
